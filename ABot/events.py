...
class Events(commands.Cog):
    ...
    async def on_guild_join(self, guild: discord.Guild):
        ...
        try:
            ...
            self.db.commit()
            await start_message.edit(content="Ура! Всё готово! Теперь я могу включить будильник... Извиняюсь, это был не мой текст. С полным перечнем команд и их описанием Вы можете ознакомиться с помощью команды /help. Также не забудьте спрятать админ команды от всех, кроме модераторов или админов.")
